...
@Component({
  selector: 'app-mini-news-one',
  templateUrl: './mini-news-one.page.html',
  styleUrls: ['./mini-news-one.page.scss'],
})
export class MiniNewsOnePage implements OnInit {
  ...
  goToPostDetails(item) {
    console.log("go to news details");
    this.service.setData(item);
    this.nav.navigateForward('mini-news-detail-one');
  }
}
