...
@Component({
  selector: 'app-mini-news-two',
  templateUrl: './mini-news-two.page.html',
  styleUrls: ['./mini-news-two.page.scss'],
})
export class MiniNewsTwoPage implements OnInit {
  ...
  goToPostDetails(item) {
    ...
    this.nav.navigateForward('mini-news-detail-two');
  }
