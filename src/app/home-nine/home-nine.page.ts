...
import { IonContent, MenuController, ToastController, NavController } from '@ionic/angular';
...
@Component({
  ...
  templateUrl: './home-nine.page.html',
  styleUrls: ['./home-nine.page.scss'],
})
export class HomeNinePage implements OnInit {
