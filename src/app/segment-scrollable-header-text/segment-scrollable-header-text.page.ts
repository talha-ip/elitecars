...
@Component({
  ...
  templateUrl: './segment-scrollable-header-text.page.html',
  styleUrls: ['./segment-scrollable-header-text.page.scss'],
  animations: [
    trigger('itemState', [
      transition('void => *', [
...
export class SegmentScrollableHeaderTextPage implements OnInit {
