...
export class CartPage implements OnInit {
  ...
  constructor(public shared: SharedDataService,public appEventsService: AppEventsService,
  ...
  goToProductDetailPage() {
    this.nav.navigateForward("bb-product-detail");
  }
  async isCoupon() {
  ...
  goToAddress() {
    this.nav.navigateForward("bb-shipping-address");
  }
  pinchEvent(e) {
