...
export class SettingOriPage implements OnInit {
  ...
  public iconColorVar = "";
  data: any;
  constructor(public toastController:ToastController,  private service: CustomThemeService ,public menuCtrl: MenuController,public appEventsService: AppEventsService,
