...
export class AboutUsPage implements OnInit {
  ...
  public iconColorVar = "";
  data: any;
  constructor(public toastController: ToastController,public appEventsService: AppEventsService, private service: CustomThemeService, public menuCtrl: MenuController, public shared: SharedDataService, public config: ConfigService, translate: TranslateService, public modalCtrl: ModalController, public nav: NavController
  ) {
