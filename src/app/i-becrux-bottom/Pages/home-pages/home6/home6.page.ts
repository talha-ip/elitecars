...
export class Home6Page implements OnInit {
  ...
  constructor(public menuCtrl: MenuController,public appEventsService: AppEventsService, private service: CustomThemeService, public config: ConfigService, public shared: SharedDataService, public nav: NavController) {
    setTimeout(() => {
      this.saleItems = [
