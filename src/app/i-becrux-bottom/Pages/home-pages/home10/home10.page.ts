...
export class Home10Page implements OnInit {
  ...
  constructor(private service: CustomThemeService,public appEventsService: AppEventsService, public menuCtrl: MenuController, public toastController: ToastController, public config: ConfigService, public shared: SharedDataService, public nav: NavController) {
