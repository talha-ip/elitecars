...
export class Home7Page implements OnInit {
  ...
  constructor(private service: CustomThemeService,public appEventsService: AppEventsService, public menuCtrl: MenuController, public config: ConfigService, public shared: SharedDataService, public nav: NavController) {
    setTimeout(() => {
      this.tab1 = [
