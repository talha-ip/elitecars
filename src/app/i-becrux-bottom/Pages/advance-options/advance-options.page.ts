...
export class AdvanceOptionsPage implements OnInit {
  ...
  constructor(private menuCtrl:MenuController, public appEventsService: AppEventsService,private navCtrl: NavController, private translate: TranslateService) {
    this.itemsHome = [
      { expandedHelp: false },
    ];
  ...
  goToHome(i) {
    if (i == 0) {
      ...
      this.navCtrl.navigateForward("bb-home2");
    }
    else if (i == 2) {
      this.navCtrl.navigateForward("bb-home3");
    }
    else if (i == 3) {
      this.navCtrl.navigateForward("bb-home4");
    }
    else if (i == 4) {
      this.navCtrl.navigateForward("bb-home5");
    }
    else if (i == 5) {
      this.navCtrl.navigateForward("bb-home6");
    }
    else if (i == 6) {
      this.navCtrl.navigateForward("bb-home7");
    }
    else if (i == 7) {
      this.navCtrl.navigateForward("bb-home8");
    }
    else if (i == 8) {
      this.navCtrl.navigateForward("bb-home9");
    }
    else if (i == 9) {
      this.navCtrl.navigateForward("bb-home10");
    }
    else if (i == 10) {
      this.navCtrl.navigateForward("bb-home10");
    }
  ...
  goToCategory(i) {
    if (i == 0) {
      ...
      this.navCtrl.navigateForward("bb-categories2");
    }
    else if (i == 2) {
      this.navCtrl.navigateForward("bb-categories3");
    }
    else if (i == 3) {
      this.navCtrl.navigateForward("bb-categories4");
    }
    else if (i == 4) {
      this.navCtrl.navigateForward("bb-categories5");
    }
    else if (i == 5) {
      this.navCtrl.navigateForward("bb-categories6");
    }
  }
  //for home expandable
  ...
  goToSearchPage() {
    this.navCtrl.navigateForward("bb-search");
  }
  goToCartPage() {
    this.navCtrl.navigateForward("bb-cart");
  }
  goToColor() {
    this.navCtrl.navigateForward("bb-color-theme");
