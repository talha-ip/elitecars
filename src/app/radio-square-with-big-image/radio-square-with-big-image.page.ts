...
templateUrl: './radio-square-with-big-image.page.html',
styleUrls: ['./radio-square-with-big-image.page.scss'],
})
export class RadioSquareWithBigImagePage implements OnInit {
public products = [
