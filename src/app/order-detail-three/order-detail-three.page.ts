...
@Component({
  ...
  selector: 'app-order-detail-three',
  templateUrl: './order-detail-three.page.html',
  styleUrls: ['./order-detail-three.page.scss'],
})
export class OrderDetailThreePage implements OnInit {
  seg2 = 2;
